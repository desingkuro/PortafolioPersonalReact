import "../shared/style/SobremiStyle.css";
import logo from "../../assets/logoKurowhite.png";
import { ItemSkills } from "../shared/components/ItemSkill";
      ...
      <main className="contenidoPrincipal">
        ...
        <section className="sectionSobremi">
          ...
          <p>
            ...
            usabilidad y el rendimiento. También cuento con buenas ha bilidades
